   ...
   public class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            button1.Text = "C into assemble nasm 32 bits";
		...
		try{
			...
			psi.Arguments = "-c \"/usr/bin/x86_64-w64-mingw32-g++ -S -m32 -masm=intel -o " + b + ".asm " + a+ " \" 2> error.txt ";
			...
			using (StreamWriter file =  new StreamWriter(b))
			{
				...
				file.WriteLine("	mov	eax, DWORD [ebp+8]");
